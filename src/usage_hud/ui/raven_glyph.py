...
def raven_watermark_html(size: int, *, line_color: QColor, eye_color: QColor | None = None) -> str:
    ...
    s = size / 32.0
    paint_raven_outline(painter, s, line_color=line_color, eye_color=eye_color, legs=True)
    painter.end()
